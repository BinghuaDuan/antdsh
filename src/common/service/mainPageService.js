...
mainPageService.mainHomeData = async (query) => {
  return {
    ...
    json: () => [
        ...
        products: [
          {
            ...
            desc: '系统可以在路由网络中通过对服务间相互调用的IP路由进行监测，进而还原服务的执行过程，并从中感知过程中的质量问题。',
        ...
        products: [
          {
            pid: 1,
            href: '/schema',
            title: '面向异构服务融合的服务资源库',
            desc: '面向异构服务融合，利用众包方式构建服务资源库，允许用户按照指定的schema定义接入新的服务资源。平台将自动将新的服务资源描述融入到服务资源描述知识图谱中。对外开放各类服务感知API，以及服务资源检索API。',
          ...
          {
            pid: 1,
            href: 'http://60.205.188.102:16002/',
            title: '服务质量与价值事件感知器',
            desc: '系统通过大量采集与服务相关的新闻媒体资讯，从中提取相关的实体关系信息以及事件信息，并将其融合成混合知识图谱，支持用户上传自定义分类算法生成分界与话题，从而实现具有时空界多维视角的服务事件分析模型。',
      ...
      {
        cid: 1,
        label: '面向质量与价值问题的服务演化工具',
        products: [
          {
            pid: 1,
            href: 'http://60.205.188.102:8085/',
            title: '面向质量与价值问题的服务演化工具',
